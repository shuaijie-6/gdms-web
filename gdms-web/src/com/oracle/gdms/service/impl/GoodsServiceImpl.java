...
//		String url = "http://csiqp89631.java.cdnjsp.org/gdms-web/rest/huazhao/push/goods/one";
	...
	@Override
	public void deldata(String goodsid) {
		// TODO 自动生成的方法存根
		try {
			session = GDMSUtil.getSession();
			GoodsDao dao = session.getMapper(GoodsDao.class);
	...
	@Override
	public GoodsModel findAll(String string) {
		// TODO 自动生成的方法存根
		return null;
	}
...
//	@Override
//	public GoodsModel findAll(GoodsType type) {
//		// TODO 自动生成的方法存根
//		try {
//			session = GDMSUtil.getSession();
//			GoodsDao dao = session.getMapper(GoodsDao.class);
//			GoodsModel goods = dao.findById(type.getGtid());
//			
//			return goods;
//		} catch (Exception e) {
//			e.printStackTrace();
